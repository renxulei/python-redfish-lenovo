...
def remove_ssh_pubkey(ip, login_account, login_password,user_name):
    """Remove SSH Pubkey    
    ...
    :returns: returns remove restult
    """
    result = {}
    login_host = "https://" + ip
    try:
...
def add_helpmessage(argget):
    argget.add_argument('--username', type=str, help='The user name you want to remove',required=True)

def add_parameter():
    """Remove SSH Pubkey parameter"""
...
if __name__ == '__main__':
    ...
    result = remove_ssh_pubkey(ip, login_account, login_password,user_name)
